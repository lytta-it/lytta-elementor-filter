 ...
 * Description: Un plugin professionale integrato con Elementor Pro Loop Grid per filtrare in tempo reale Custom Post Types, Tassonomie e campi ACF. Proprierario di Lytta.
 * Plugin URI: https://lytta.it/plugin/elementor-advanced-filter
 * Author: Lytta.it
 * Version: 1.1.0
...
define('LYTTA_FILTER_VERSION', '1.1.0');
